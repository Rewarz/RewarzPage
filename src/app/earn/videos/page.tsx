...
const platforms = [
  {
    ...
    dailyLimit: 10,
    description:
      "Videos publicitarios de alta calidad con las mejores tasas de pago.",
  ...
  const handleStartWatchingAds = (platformId: number) => {
    ...
    if (platform?.provider === "adsterra") {
      if (remainingViews > 0) {
        ...
        alert(
          "Has alcanzado el límite diario de anuncios. Vuelve mañana para ganar más recompensas."
        );
      }
    }
  };
  ...
  const handleAdCompleted = () => {
    ...
    setEarnings((prev) => {
      ...
      if (platform) {
        ...
        const minPay = Number.parseFloat(
          payRange.split(" - ")[0].replace("$", "")
        );
        return prev + minPay;
      }
      return prev;
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Selecciona tu plataforma preferida y comienza a ganar recompensas
              por ver anuncios de video
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-20">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">
                Selecciona entre nuestros proveedores verificados según tus
                preferencias de pago y contenido
              </p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              <div className="w-12 h-12 rounded-full bg-green-500/20 flex items-center justify-center text-green-500 mb-4">
              ...
              <p className="text-gray-400">
                Visualiza anuncios cortos y asegúrate de cumplir con los
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">
                Acumula tus ganancias y retira cuando alcances el mínimo
                requerido
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-6">
              {platforms.map((platform) => (
                <div
                  ...
                  onClick={() =>
                    setSelectedPlatform(
                      platform.id === selectedPlatform ? null : platform.id
                    )
                  }
                >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">
                Todo lo que necesitas saber sobre ganar dinero viendo videos
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-2">
                  ¿Cómo me aseguro de recibir el pago?
                </h3>
                <p className="text-gray-400">
                  Asegúrate de ver el video completo y cumplir con los
                  requisitos específicos de cada plataforma. Los pagos se
                  procesan automáticamente una vez verificada la visualización.
                </p>
              </div>
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-2">
                ...
                <p className="text-gray-400">
                  Sí, puedes utilizar diferentes plataformas para maximizar tus
                  ganancias, respetando los límites diarios de cada una.
                </p>
              </div>
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-2">
                ...
                <p className="text-gray-400">
                  Cada plataforma tiene su propio mínimo de retiro. Una vez
                  alcanzado, podrás transferir tus ganancias a tu cuenta
                  bancaria o billetera digital.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Comienza a ganar dinero ahora
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              No esperes más para empezar a generar ingresos extra desde la
